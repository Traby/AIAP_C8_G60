...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log("Step 3: OpenAI synthesizing briefing...");
        ...
        input: [
          {
            ...
            content: [
              {
                type: "input_text",
                text: `You are an expert research analyst. Based on the scraped content from multiple websites below, write a concise, professional 1-page research briefing that answers the following question:
...
Write the briefing now:`,
    ...
    const briefing = openaiData.output_text || "";
